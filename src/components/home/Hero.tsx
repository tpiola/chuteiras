    ...
    <section className="relative overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#0A0A0A] via-[#0A1A0A] to-[#05220A]">
        <div className="absolute inset-0 opacity-20" style={{
          backgroundImage: "radial-gradient(circle at 30% 50%, rgba(0,179,65,0.10) 0%, transparent 60%), radial-gradient(circle at 70% 20%, rgba(255,215,0,0.06) 0%, transparent 50%)",
        }} />
      </div>
      ...
      <div className="mx-auto flex max-w-7xl flex-col-reverse items-center px-4 py-12 md:flex-row md:min-h-[86vh] md:px-8 md:py-0 relative z-10">
        ...
        <div className="w-full pb-8 pt-4 md:w-1/2 md:py-20 md:pr-10">
          ...
          >
            <span className="inline-flex items-center gap-2 rounded-full bg-accent/10 border border-accent/30 px-4 py-1.5 text-xs font-bold text-accent backdrop-blur-sm">
          ...
          >
            Domine o campo com estilo. As melhores chuteiras para campo, society e futsal. Nike, Adidas, Puma, Mizuno e a linha exclusiva Roberto.
          </motion.p>
        ...
        <div className="relative w-full md:w-1/2 md:min-h-[86vh]">
          ...
          <div className="relative z-10 flex items-center justify-center py-12 md:min-h-[86vh]">
            ...
            >
              ...
              <motion.div
                ...
                className="text-[140px] leading-none select-none filter drop-shadow-[0_0_40px_rgba(0,179,65,0.3)]"
              >
                ⚽
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute -left-12 top-0 text-[80px] leading-none select-none filter drop-shadow-[0_0_30px_rgba(0,179,65,0.25)]"
              >
                👟
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute -right-10 top-4 text-[72px] leading-none select-none filter drop-shadow-[0_0_25px_rgba(255,215,0,0.2)]"
              >
                👟
              </motion.div>
            </motion.div>
          ...
          <motion.div
            ...
            className="absolute bottom-10 left-4 z-20 hidden rounded-2xl bg-surface border border-border p-3.5 shadow-[0_8px_32px_rgba(0,179,65,0.10)] md:block"
          >
