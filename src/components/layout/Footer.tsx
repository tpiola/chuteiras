...
export default function Footer() {
  ...
  return (
    <footer className="border-t-4 border-accent bg-surface shadow-[0_-4px_24px_rgba(0,179,65,0.05)]">
      {/* ── Top section ── */}
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-foreground/60">
              {SITE.tagline}. Loja oficial de chuteiras premium. Do campo à vitória. Frete grátis para todo Brasil.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              {[
                ...
                { label: "Linha Roberto", href: "/colecao" },
              ].map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              {[
                { label: "Sobre a Roberto", href: "/sobre" },
      ...
      <div className="border-t border-border bg-background">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-4 py-4 text-[11px] text-foreground/20 md:flex-row md:px-8">
          <div>
            <p>© {year} <strong className="text-foreground/40">Roberto</strong> — Chuteiras Premium</p>
