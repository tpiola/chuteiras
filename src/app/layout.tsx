...
export const metadata: Metadata = {
  ...
  title: {
    default: "Roberto — Chuteiras Premium",
    template: `%s | Roberto`,
  },
  description:
    "Roberto: loja oficial de chuteiras premium. Modelos exclusivos para campo, society e futsal. Nike, Adidas, Puma, Mizuno, Umbro, Penalty e linha Roberto. Frete grátis Brasil.",
  keywords: [
    "chuteiras premium", "chuteiras campo", "chuteiras society", "chuteiras futsal",
    "roberto chuteiras", "loja de chuteiras", "nike chuteiras", "adidas chuteiras",
    "chuteiras frete grátis", "chuteiras originais",
  ],
  icons: {
    icon: [
  ...
  openGraph: {
    ...
    locale: "pt_BR",
    type: "website",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Roberto Chuteiras Premium" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Roberto — Chuteiras Premium",
    description: "Chuteiras premium para quem domina o jogo. Do campo à vitória.",
    images: ["/og-image.png"],
  },
...
export default function RootLayout({
  ...
  const organizationJsonLd = {
    ...
    description:
      "Roberto: loja oficial de chuteiras premium. Modelos exclusivos para campo, society e futsal.",
    sameAs: [
      "https://instagram.com/robertochuteiras",
    ],
    contactPoint: {
      "@type": "ContactPoint",
  ...
  const productCatalogJsonLd = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "Catálogo Roberto — Chuteiras Premium",
